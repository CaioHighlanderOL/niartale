...
## 3. Controlar Raca e Sub-raca como campos estruturados

**Prioridade:** fidelidade a planilha, estrutura de dados  
**Planilha:** E8, G8 e todas as formulas que dependem de raca/sub-raca  
**Status atual:** `race` e string livre; sub-raca depende de `customFields["Sub-raca"]`.

- Trocar raca para opcoes controladas compatíveis com a planilha.
- Promover sub-raca para campo proprio ou select controlado.
- Preservar migracao a partir do campo customizado existente.
- Evitar que renomear/deletar campo customizado quebre bonus raciais.

**Dependencias tecnicas:** deve vir antes de expandir sub-racas, HATE/HOPE percentual ou novas regras raciais.  
**Risco:** medio; afeta diretamente `excelCalc()`.  
**Criterio de pronto:** calculos raciais dependem de chaves estaveis, nao de labels editaveis.

## 4. Exibir total de pericia com atributo base
